...
{
    [Table("ProfessionalActivities")] // Tên bảng trong Database
    public class ProfessionalActivity : AuditableEntity
    {
        [Key]
        ...
        [Display(Name = "Thực hiện chương trình (Chỉ ghi những lớp chậm, nhanh, cùng biện pháp giải quyết)")]
        ...
        // Giả sử bạn dùng string làm Key cho User (Mặc định của Identity)
        [Required]
        public string AppUserId { get; set; }

        [ForeignKey("AppUserId")]
        public virtual ApplicationUser AppUser { get; set; } // Thay AppUser bằng tên class User của bạn (ví dụ ApplicationUser)
    }
}
