...
namespace SchoolManagement.Data.Migrations
{
    ...
    [Migration("20260115084209_UpdateProfessionalActivity1")]
    partial class UpdateProfessionalActivity1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SchoolManagement.Data.Entities.LectureCalendar", b =>
                {
                    ...
                    b.ToTable("LectureCalendars", null, t =>
                        {
                            t.HasCheckConstraint("CK_LectureCalendar_Week", "[Week] >= 1 AND [Week] <= 52");
                        });
                });

            modelBuilder.Entity("SchoolManagement.Data.Entities.LectureCalendarDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LectureCalendarId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Data.Entities.ProfessionalActivity", b =>
                {
                    ...
                    b.ToTable("ProfessionalActivities");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SchoolManagement.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Data.Entities.LectureCalendarDetail", b =>
                {
                    b.HasOne("SchoolManagement.Data.Entities.LectureCalendar", "LectureCalendar")
                        .WithMany("Details")
                        .HasForeignKey("LectureCalendarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
